...
<head>
    ...
    <style>
        ...
        .dark-theme {
            ...
            /* Botão primário claro no tema escuro */
            --footer-bg: #1e1e1e;
        ...
        .nav-item.special-item .icon-wrapper {
            background-color: var(--special-icon-bg);
            border-radius: 50%;
            width: 50px;
            height: 50px;
        ...
        .nav-item.special-item .icon-wrapper i {
            font-size: 24px;
            color: var(--special-icon-color);
            margin-bottom: 0;
        }

        .nav-item.special-item.active .icon-wrapper {
            background-color: var(--special-icon-active-bg);
        }

        .nav-item.special-item.active span {
            color: var(--footer-icon-active);
        }
...
<body>
    ...
    <div class="main-container" id="main-container">
        ...
        <footer class="footer-nav">
            ...
            <a href="configuracoes.php" class="nav-item" data-target="configuracoes"> <i class="fas fa-cog"></i> <span>Configurações</span> </a>
